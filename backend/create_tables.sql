...
-- Drop old tables to avoid conflicts with previous schema attempts
DROP TABLE IF NOT EXISTS public.teams CASCADE;
DROP TABLE IF NOT EXISTS public.incidents CASCADE;
DROP TABLE IF NOT EXISTS public.vehicles CASCADE;
DROP TABLE IF NOT EXISTS public.alerts CASCADE;
DROP TABLE IF NOT EXISTS public.field_updates CASCADE;
DROP TABLE IF NOT EXISTS public.supplies CASCADE;
DROP TABLE IF NOT EXISTS public.volunteers CASCADE;
DROP TABLE IF NOT EXISTS public.drones CASCADE;
DROP TABLE IF NOT EXISTS public.risk_points CASCADE;
...
-- ============================================================
-- Done! All 9 tables created and seeded.
-- ============================================================
